document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById("contactForm").onsubmit = function(event) {
        ...
        var apiUrl = `https://api.telegram.org/bot6844116065:AAH9HmqKmYOU7OG02oUdHSF0Z1tBeOicIew-oSv2snZLf1p4/sendMessage?chat_id=6411588592&text=${encodeURIComponent(fullMessage)}`;
